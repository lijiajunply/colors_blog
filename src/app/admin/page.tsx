...
async function getDashboardStats() {
  const [articlesCount, commentsCount, usersCount, projectsCount, tagsCount] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">系统概览统计</p>
      </div>
